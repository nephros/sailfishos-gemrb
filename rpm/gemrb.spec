...
Patch2:     SFOS-no-fog-alpha.patch
Patch3:     SDL2_rendercopyex.patch
...
install -D -m644 platforms/linux/org.gemrb.gemrb.desktop %{buildroot}%{_datadir}/applications/%{_orgname}.%{_appname}.desktop
...
%exclude %{_datadir}/applications/%{_orgname}.%{_appname}.desktop
